"""
SELECTIVE FLAC DOWNLOADER — From item list to USB drive
======================================================
...
# ── EDIT THESE LINES ──────────────────────────────────────────────────────────
USB_DRIVE_PATH = r"D:\aadamjacobs"   # <-- CHANGE THIS to your USB path
ITEM_LIST_FILE = "get_list.txt"      # <-- Text file with one item ID per line
# ──────────────────────────────────────────────────────────────────────────────

RETRY_ATTEMPTS = 3
RETRY_DELAY = 5

LOG_FILE = os.path.join(USB_DRIVE_PATH, "_download_log.txt")
FAILED_FILE = os.path.join(USB_DRIVE_PATH, "_failed_downloads.txt")
SUCCESS_FILE = os.path.join(USB_DRIVE_PATH, "_successful_downloads.txt")
...
def main():
    print("=" * 72)
    print(" SELECTIVE FLAC DOWNLOADER — From list to USB")
    print(f" USB path       : {USB_DRIVE_PATH}")
    ...
    for item_num, item_id in enumerate(item_ids, start=1):
        ...
        item_folder = os.path.join(USB_DRIVE_PATH, safe_folder_name(item_id))
